...
class Agent(object):
    ...
    def train(self, env, opponent, resume=False, print_things=True, train_run_id=285, train_episodes=20000):
        ...
        if not resume:
            ...
            self.policy = Policy(obs_space_dim-2, act_space_dim).to(self.train_device)
    ...
    def get_action_train(self, observation):
        ...
        observation = np.array([observation[0], observation[1], observation[3], observation[5]])
